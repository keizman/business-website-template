      ...
      <div className='w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]'>
        ...
        <div className='w-full md:mt-0 mt-6'>
          <p className={`${styles.paragraph} text-left max-w-[450px]`}>
            Trusted by leading enterprises worldwide. See how Planktonfly's AI solutions are transforming businesses.
          </p>  
        </div>
      </div>
      <div className='flex flex-wrap sm:justify-start justify-center w-full feedback-contrainer relative z-[1]'>
        {feedback.map((card, index) => (
          <ScrollReveal key={card.id} direction="up" distance={60} delay={index * 150}>
            <Feedback {...card}/>        
          </ScrollReveal>
        ))}
      </div>      
